...
! function (t, e) {
	...
	return function (t) {
		...
		e.isNumber = function (t) {
			...
			if (t)
				for (; !0 === t.hasChildNodes();) e.recursiveDOMDelete(t.firstChild), t.removeChild(t.firstChild)
			...
			for (var i in t) t.hasOwnProperty(i) && "object" !== (0, p.default)(t[i]) && (t[i] = e)
		}, e.fillIfDefined = function (t, i) {
			var o = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
			for (var s in t) void 0 !== i[s] && (null === i[s] || "object" !== (0, p.default)(i[s]) ? n(t, i, s, o) : "object" === (0, p.default)(t[s]) && e.fillIfDefined(t[s], i[s], o))
		...
		e.addCssText = function (t, i) {
			...
			if (null !== i && "object" === (void 0 === i ? "undefined" : (0, p.default)(i))) {
				for (var o = (0, h.default)(i), n = 0; n < t.length; n++) i.hasOwnProperty(t[n]) && "object" == (0, p.default)(i[t[n]]) && (o[t[n]] = e.bridgeObject(i[t[n]]));
				return o
			}
			return null
			...
			if (null !== t && "object" === (void 0 === t ? "undefined" : (0, p.default)(t))) {
				...
				if (t instanceof Element) i = t;
					...
					i = (0, h.default)(t);
					for (var o in t) t.hasOwnProperty(o) && "object" == (0, p.default)(t[o]) && (i[o] = e.bridgeObject(t[o]))
				}
				return i
			}
			return null
			...
			for (var n = 0, s = 0, r = t.length - 1; s <= r && n < 1e4;) {
				var a = Math.floor((s + r) / 2),
					...
					l = e(d);
				if (0 == l) return a; - 1 == l ? s = a + 1 : r = a - 1, n++
			}
			return -1
		...
		n.prototype.setOptions = function (t) {
			t && void 0 !== t.queue && (!1 === t.queue ? this._queue && (this._queue.destroy(), delete this._queue) : (this._queue || (this._queue = p.extend(this, {
			...
			if (Array.isArray(t))
				for (var l = 0, p = t.length; l < p; l++) t[l] && "object" === (0, h.default)(t[l]) ? d(t[l]) : console.warn("Ignoring input item, which is not an object at index " + l);
			else {
				if (!t || "object" !== (void 0 === t ? "undefined" : (0, h.default)(t))) throw new Error("Unknown dataType");
				d(t)
			}
			...
			var a, h, d, p, c, m = o && o.type || this._options.type,
				f = o && o.filter,
				g = [];
			if (void 0 != e)(a = n._getItem(e, m)) && f && !f(a) && (a = null);
			else if (void 0 != i)
				for (p = 0, c = i.length; p < c; p++) a = n._getItem(i[p], m), f && !f(a) || g.push(a);
			else
				for (h = (0, l.default)(this._data), p = 0, c = h.length; p < c; p++) d = h[p], a = n._getItem(d, m), f && !f(a) || g.push(a);
			if (o && o.order && void 0 == e && this._sort(g, o.order), o && o.fields) {
				var v = o.fields;
				if (void 0 != e) a = this._filterFields(a, v);
				else
					for (p = 0, c = g.length; p < c; p++) g[p] = this._filterFields(g[p], v)
			}
			if ("Object" == r) {
				var y, b = {};
			...
			if (a)
				if (h) {
					...
					for (this._sort(s, h), e = 0, i = s.length; e < i; e++) p.push(s[e][this._fieldId])
				} else
					for (e = 0, i = u.length; e < i; e++) o = u[e], n = this._getItem(o, d), a(n) && p.push(n[this._fieldId]);
			else if (h) {
				for (s = [], e = 0, i = u.length; e < i; e++) o = u[e], s.push(r[o]);
				for (this._sort(s, h), e = 0, i = s.length; e < i; e++) p.push(s[e][this._fieldId])
			} else
				for (e = 0, i = u.length; e < i; e++) o = u[e], n = r[o], p.push(n[this._fieldId]);
			return p
		...
		var o = i(6),
			...
			a = function (t, e, i) {
				...
				p && (i = e);
				for (h in i)(d = !u && b && void 0 !== b[h]) && h in v || (l = d ? b[h] : i[h], v[h] = p && "function" != typeof b[h] ? i[h] : f && d ? s(l, o) : g && b[h] == l ? function (t) {
			...
			if (a && this._data) {
				switch (t) {
					case "add":
						...
						break;
					case "update":
						for (o = 0, n = a.length; o < n; o++) s = a[o], r = this.get(s), r ? this._ids[s] ? (d.push(s), p.push(e.data[o]), u.push(e.oldData[o])) : (this._ids[s] = !0, h.push(s)) : this._ids[s] && (delete this._ids[s], l.push(s), c.push(e.oldData[o]));
						break;
					case "remove":
						for (o = 0, n = a.length; o < n; o++) s = a[o], this._ids[s] && (delete this._ids[s], l.push(s), c.push(e.oldData[o]))
				}
		...
		e.convertHiddenOptions = function (t, i, o) {
			...
			if (o && void 0 !== i.domProps.centerContainer.width) {
				...
				for (var n = t(i.range.start), s = t(i.range.end), r = i.range.end - i.range.start, a = r / i.domProps.centerContainer.width, h = 0; h < o.length; h++)
					if (void 0 !== o[h].repeat) {
						...
						if (u >= 4 * a) {
							...
							switch (o[h].repeat) {
								case "daily":
									d.day() != l.day() && (p = 1), d.dayOfYear(n.dayOfYear()), d.year(n.year()), d.subtract(7, "days"), l.dayOfYear(n.dayOfYear()), l.year(n.year()), l.subtract(7 - p, "days"), c.add(1, "weeks");
									break;
								case "weekly":
									var m = l.diff(d, "days"),
										f = d.day();
									d.date(n.date()), d.month(n.month()), d.year(n.year()), l = d.clone(), d.day(f), l.day(f), l.add(m, "days"), d.subtract(1, "weeks"), l.subtract(1, "weeks"), c.add(1, "weeks");
									break;
								case "monthly":
									d.month() != l.month() && (p = 1), d.month(n.month()), d.year(n.year()), d.subtract(1, "months"), l.month(n.month()), l.year(n.year()), l.subtract(1, "months"), l.add(p, "months"), c.add(1, "months");
									break;
								case "yearly":
									d.year() != l.year() && (p = 1), d.year(n.year()), d.subtract(1, "years"), l.year(n.year()), l.subtract(1, "years"), l.add(p, "years"), c.add(1, "years");
									break;
								default:
									return void console.log("Wrong repeat format, allowed are: daily, weekly, monthly, yearly. Given:", o[h].repeat)
							}
							for (; d < c;) switch (i.hiddenDates.push({
								start: d.valueOf(),
								end: l.valueOf()
							}), o[h].repeat) {
								case "daily":
				...
				var g = e.isHidden(i.range.start, i.hiddenDates),
					...
					y = i.range.start,
					b = i.range.end;
				1 == g.hidden && (y = 1 == i.range.startToFront ? g.startDate - 1 : g.endDate + 1), 1 == v.hidden && (b = 1 == i.range.endToFront ? v.startDate - 1 : v.endDate + 1), 1 != g.hidden && 1 != v.hidden || i.range._applyRange(y, b)
			}
		...
		n.prototype.stack = !0, n.prototype.select = function () {
			...
			if (this.options.visibleFrameTemplate ? (n = this.options.visibleFrameTemplate.bind(this), o = n(s, r)) : o = "", a)
				...
				else if (this._contentToString(this.itemVisibleFrameContent) !== this._contentToString(o)) {
		...
		o.prototype = new a, o.prototype.setOptions = function (t) {
			...
			var l, p, c, m, f, g, v, y, b, _ = 0,
				w = void 0,
				x = 0;
			for (s.start(), l = s.getCurrent(), c = this.body.util.toScreen(l); s.hasNext() && x < 1e3;) {
				switch (x++, m = s.isMajor(), b = s.getClassName(), y = s.getLabelMinor(), l, p = c, s.next(), l = s.getCurrent(), s.isMajor(), c = this.body.util.toScreen(l), g = _, _ = c - p, s.scale) {
					case "week":
						f = !0;
						break;
					default:
				...
				return (0, c.default)(t, null, [{
					...
					value: function (e, i, o, n, s, r) {
						var a = function (i) {
							...
							h = t.getType(i[e]),
							l = s[h];
						void 0 !== l ? "array" === t.getType(l) && -1 === l.indexOf(i[e]) ? (a('Invalid option detected in "' + e + '". Allowed values are:' + t.print(l) + ' not "' + i[e] + '". '), f = !0) : "object" === h && "__any__" !== n && (r = m.copyAndExtendArray(r, e), t.parse(i[e], o[n], r)) : void 0 === s.any && (a('Invalid type received for "' + e + '". Expected: ' + t.print((0, d.default)(s)) + ". Received [" + h + '] "' + i[e] + '"'), f = !0)
					}
				}, {
					key: "getType",
					value: function (t) {
					...
					value: function (e, i, o) {
						...
						for (var l in i) {
							...
							if (void 0 !== i[l].__type__ && !0 === n) {
								var p = t.findInOptions(e, i[l], m.copyAndExtendArray(o, l));
								s > p.distance && (r = p.closestMatch, a = p.path, s = p.distance, d = p.indexMatch)
		...
		var o = i(18),
			...
			h = function () {
				var t, e = i(58)("iframe"),
					o = s.length;
				for (e.style.display = "none", i(99).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write("<script>document.F=Object<\/script>"), t.close(), h = t.F; o--;) delete h.prototype[s[o]];
				return h()
			};
		...
		function n(t, e) {
			...
			}, this.options = p.extend({}, this.defaultOptions), this.props = {
				touch: {}
		...
		var r = i(4),
			...
			m = i(5),
			f = i(21);
		n.prototype = new m, n.prototype.setOptions = function (t) {
			if (t) {
				...
				p.selectiveExtend(e, this.options, t), t.rollingMode && t.rollingMode.follow && this.startRolling(), ("start" in t || "end" in t) && this.setRange(t.start, t.end)
			}
			...
			if (this._cancelAnimation(), this.millisecondsPerPixelCache = void 0, i.animation) {
				...
				if (!v) throw new Error("Unknown easing function " + (0, d.default)(g) + ". Choose from: " + (0, a.default)(p.easingFunctions).join(", "));
				...
				return function t() {
					if (!s.props.touch.dragging) {
						...
						_ = s._applyRange(p, g), f.updateHiddenDates(s.options.moment, s.body, s.options.hiddenDates), b = b || _;
						var w = {
			...
			if (f.updateHiddenDates(this.options.moment, this.body, this.options.hiddenDates), _) {
				var w = {
			...
			var i, o = null != t ? p.convert(t, "Date").valueOf() : this.start,
				n = null != e ? p.convert(e, "Date").valueOf() : this.end,
				s = null != this.options.max ? p.convert(this.options.max, "Date").valueOf() : null,
				r = null != this.options.min ? p.convert(this.options.min, "Date").valueOf() : null;
			...
			if (t && this.props.touch.dragging && this.options.moveable && this.props.touch.allowDragging) {
				...
				var a = this.props.touch.start + n,
					...
					l = f.snapAwayFromHidden(this.body.hiddenDates, h, this.previousDelta - i, !0);
			...
			if (t.wheelDelta ? e = t.wheelDelta / 120 : t.detail && (e = -t.detail / 3), !(this.options.zoomKey && !t[this.options.zoomKey] && this.options.zoomable || !this.options.zoomable && this.options.moveable) && this.options.zoomable && this.options.moveable && this._isInsideRange(t) && e) {
				...
				i = e < 0 ? 1 - e / 5 : 1 / (1 + e / 5);
				var o;
				if (this.rolling) o = this.start + (this.end - this.start) * this.options.rollingMode.offset;
				else {
			...
			if (this.options.zoomable && this.options.moveable) {
				p.preventDefault(t), this.props.touch.allowDragging = !1, this.props.touch.center || (this.props.touch.center = this.getPointer(t.center, this.body.dom.center)), this.stopRolling();
			...
			e = this.options.rtl ? i - p.getAbsoluteLeft(this.body.dom.centerContainer) : p.getAbsoluteRight(this.body.dom.centerContainer) - i;
			...
			var n = f.getHiddenDurationBetween(this.body.hiddenDates, this.start, this.end),
		...
		d(n.prototype), n.prototype._create = function (t) {
			function e(t) {
				...
				var e = 0,
					i = 0;
				if ("detail" in t && (i = -1 * t.detail), "wheelDelta" in t && (i = t.wheelDelta), "wheelDeltaY" in t && (i = t.wheelDeltaY), "wheelDeltaX" in t && (e = -1 * t.wheelDeltaX), "axis" in t && t.axis === t.HORIZONTAL_AXIS && (e = -1 * i, i = 0), "deltaY" in t && (i = -1 * t.deltaY), "deltaX" in t && (e = t.deltaX), this.options.zoomKey && !t[this.options.zoomKey])
			...
			var s = this;
			this._origRedraw = this._redraw.bind(this), this._redraw = p.throttle(this._origRedraw), this.on("_change", function (t) {
			...
			if (t) {
				...
				if ("function" == typeof t.drawPoints && (t.drawPoints = {
					...
					}), "hiddenDates" in this.options && f.convertHiddenOptions(this.options.moment, this.body, this.options.hiddenDates), "clickToUse" in t && (t.clickToUse ? this.activator || (this.activator = new m(this.dom.root)) : this.activator && (this.activator.destroy(), delete this.activator)), "showCustomTime" in t) throw new Error("Option `showCustomTime` is deprecated. Create a custom time bar via timeline.addCustomTime(time [, id])");
			...
			var o = new g(this.body, p.extend({}, this.options, {
				time: i,
				id: e
			}));
			...
			var n, s;
			1 == arguments.length ? (s = arguments[0], n = void 0 === s.animation || s.animation, this.range.setRange(s.start, s.end, {
				animation: n
			})) : 2 == arguments.length && "function" == typeof arguments[1] ? (s = arguments[0], o = arguments[1], n = void 0 === s.animation || s.animation, this.range.setRange(s.start, s.end, {
				animation: n
			}, o)) : (n = !i || void 0 === i.animation || i.animation, this.range.setRange(t, e, {
				animation: n
			}, o))
			...
			if (o && o.container && 0 != o.root.offsetWidth) {
				...
				o.root.style.height = p.option.asSize(e.height, s + "px"), i.root.height = o.root.offsetHeight, i.background.height = i.root.height - i.borderRootHeight;
			...
			this._stopAutoResize(), this._onResize = function () {
				...
				t.dom.root && (t.dom.root.offsetWidth == t.props.lastWidth && t.dom.root.offsetHeight == t.props.lastHeight || (t.props.lastWidth = t.dom.root.offsetWidth, t.props.lastHeight = t.dom.root.offsetHeight, t.props.scrollbarWidth = p.getScrollBarWidth(), t.body.emitter.emit("_change")))
		...
		o.FORMAT = {
			...
			switch (this.scale) {
				...
				case "weekday":
					...
					break;
				case "day":
					h.push("vis-day" + r.date()), h.push("vis-" + r.format("MMMM").toLowerCase()), h.push(e(r)), h.push(o(r)), h.push(this.step <= 2 ? e(r) : ""), h.push(this.step <= 2 ? "vis-" + r.format("dddd").toLowerCase() : ""), h.push(t(r.date() - 1));
					break;
				case "week":
		...
		o.prototype._create = function () {
			...
			if (t != this.lastMarkerHeight) {
				...
				if (i > 0)
					for (var o = 0; o < i; o++) r.forEach(e, function (t) {
						t[o]()
					});
				return !0
			}
			...
			if (t || this.stackDirty || this.isVisible && !e) {
				...
				if ("function" == typeof this.itemSet.options.order) {
					...
					if (r.forEach(this.items, function (t, e) {
						...
						for (var u = 0; u < l; u++) r.forEach(d, function (t) {
							t[u]()
						});
			...
			var e = this.visibleItems.indexOf(t); - 1 != e && this.visibleItems.splice(e, 1), void 0 !== t.data.subgroup && (this._removeFromSubgroup(t), this.orderSubgroups())
			...
			if (m > 0)
				for (var g = 0; g < m; g++) r.forEach(c, function (t) {
					t[g]()
				});
		...
		o.prototype = new n(null, null, null), o.prototype.baseClassName = "vis-item vis-range", o.prototype.isVisible = function (t) {
			...
			var e, i = [this._createDomElement.bind(this), this._appendDomElement.bind(this), this._updateDirtyDomComponents.bind(this), function () {
		...
		t.exports = function (t, e, i, f, g, v, y) {
			...
			if (E && (w = u(E.call(new t))) !== Object.prototype && w.next && (l(w, D, !0), o || a(w, p) || r(w, p, m)), S && T && "values" !== T.name && (k = !0, M = function () {
					return T.call(this)
				}), o && !y || !c && !k && C[p] || r(C, p, M), h[e] = M, h[D] = m, g)
				if (b = {
						values: S ? M : x("values"),
						keys: v ? M : x("keys"),
						entries: O
		...
		n.prototype = new m, n.types = {
			...
			s.show(), this.groups[D] = s, this.hammer = new d(this.body.dom.centerContainer), this.hammer.on("hammer.input", function (t) {
			...
			for (var n in this.groups)
				if (this.groups.hasOwnProperty(n))
					for (var s = this.groups[n], r = s.isVisible ? s.visibleItems : [], a = 0; a < r.length; a++) {
						var h = r[a];
			...
			var e, i = this,
				o = this.itemsData;
			if (t) {
				if (!(t instanceof u || t instanceof p)) throw new TypeError("Data must be an instance of DataSet or DataView");
				this.itemsData = t
			...
			if (this.groupsData) {
				...
				this.groupsData instanceof p && (o = this.groupsData.getDataSet()), o.get().forEach(function (t) {
			...
			t.forEach(function (t) {
				...
				if (o) o.setData(i);
					...
					if (t == x || t == D) throw new Error("Illegal group id. " + t + " is a reserved id.");
					var n = (0, r.default)(e.options);
					l.extend(n, {
						height: null
					}), o = new f(t, i, e), e.groups[t] = o;
			...
			c.id = u, c.data = this._cloneItemData(d), this._addItem(c), this.touchParams.selectedItem = c;
			var m = {
				item: c,
				initialX: t.center.x,
				data: c.data
			};
			this.options.rtl ? m.dragLeft = !0 : m.dragRight = !0, this.touchParams.itemProps = [m], t.stopPropagation()
		}, n.prototype._onDrag = function (t) {
			if (this.touchParams.itemProps) {
				...
				this.touchParams.itemProps.forEach(function (d) {
					var u, p, c, m, f, g = i.body.util.toTime(t.center.x - e),
					...
					if (null == d.item.editable || d.item.editable.updateTime || d.item.editable.updateGroup || i.options.editable.overrideItems) {
						if ((this.options.editable.overrideItems || null == r.editable) && this.options.editable.updateTime || !this.options.editable.overrideItems && null != r.editable && r.editable.updateTime)
							if (d.dragLeft) this.options.rtl ? void 0 != y.end && (c = l.convert(d.data.end, "Date"), f = new Date(c.valueOf() + u), y.end = o ? o(f, n, s) : f) : void 0 != y.start && (p = l.convert(d.data.start, "Date"), m = new Date(p.valueOf() + u), y.start = o ? o(m, n, s) : m);
							else if (d.dragRight) this.options.rtl ? void 0 != y.start && (p = l.convert(d.data.start, "Date"), m = new Date(p.valueOf() + u), y.start = o ? o(m, n, s) : m) : void 0 != y.end && (c = l.convert(d.data.end, "Date"), f = new Date(c.valueOf() + u), y.end = o ? o(f, n, s) : f);
						else if (void 0 != y.start)
							if (p = l.convert(d.data.start, "Date").valueOf(), m = new Date(p + u), void 0 != y.end) {
								c = l.convert(d.data.end, "Date");
								var b = c.valueOf() - p.valueOf();
								y.start = o ? o(m, n, s) : m, y.end = new Date(y.start.valueOf() + b)
			...
			if (e && e.nestedGroups) {
				...
				if (i.update(n.concat(o)), o.showNested) l.removeClassName(e.dom.label, "collapsed"), l.addClassName(e.dom.label, "expanded");
				else {
			...
			if (this.options.groupEditable.order && this.groupTouchParams.group) {
				...
				if (i && i != this.groupTouchParams.group) {
					...
					if (!l.equalArray(d, this.groupTouchParams.originalOrder))
						for (var u = this.groupTouchParams.originalOrder, c = this.groupTouchParams.group.groupId, m = Math.min(u.length, d.length), f = 0, g = 0, v = 0; f < m;) {
			...
			if (this.options.selectable && this.options.editable.add) {
				...
				var s, r, a = this.body.util.toTime(i),
			...
			m = function () {
				function t(e, i, o) {
					...
					(0, d.default)(this, t), this.parent = e, this.changedOptions = [], this.container = i, this.allowCreation = !1, this.options = {}, this.initialized = !1, this.popupCounter = 0, this.defaultOptions = {
						...
						container: void 0,
						showButton: !0
					}, p.extend(this.options, this.defaultOptions), this.configureOptions = o, this.moduleOptions = {}, this.domElements = [], this.popupDiv = {}, this.popupLimit = 5, this.popupHistory = {}, this.colorPicker = new c(n), this.wrapper = void 0
				}
				return (0, u.default)(t, [{
					...
					value: function (t, e, i) {
						...
						"" !== h && this.popupHistory[c] !== d && (this.popupHistory[c] = d, this._setupPopup(h, c))
					}
				}, {
					key: "_setupPopup",
					value: function (t, e) {
							...
							if (t.hasOwnProperty(r)) {
								...
								if ("function" == typeof n && !1 === (o = n(r, e)) && !(a instanceof Array) && "string" != typeof a && "boolean" != typeof a && a instanceof Object && (this.allowCreation = !1, o = this._handleObject(a, h, !0), this.allowCreation = !1 === i), !1 !== o) {
									...
									if (a instanceof Array) this._handleArray(a, d, h);
										...
										var l = !0;
										if (-1 !== e.indexOf("physics") && this.moduleOptions.physics.solver !== r && (l = !1), !0 === l)
											if (void 0 !== a.enabled) {
		...
		o.prototype = new l, o.prototype._create = function () {
			...
			if (null != this.itemsData) {
				...
				for (h = 0; h < o.length; h++)
					if (d = o[h], l = d.group, null !== l && void 0 !== l || (l = "__ungrouped__"), e || !t || d[n] === s[d[n]] || !u.hasOwnProperty(d[n])) {
						...
						m.x = r.convert(d.x, "Date"), m.end = r.convert(d.end, "Date"), m.orginalY = d.y, m.y = Number(d.y), m[n] = d[n];
				...
				for (l in i)
					if (i.hasOwnProperty(l))
						if (0 == i[l].length) this.groups.hasOwnProperty(l) && this._removeGroup(l);
							...
							var g = void 0;
							void 0 != this.groupsData && (g = this.groupsData.get(l)), void 0 == g && (g = {
								id: l,
								content: this.options.defaultGroup + l
							}), this._updateGroup(g, l), this.groups[l].setItems(i[l])
						}
				this.forceGraphUpdate = !0, this.body.emitter.emit("_change", {
					queue: !0
				})
				...
				if (s.length > 0) {
					...
					for (e = 0; e < s.length; e++)
						if (t = this.groups[s[e]], "line" === t.options.style && 1 == t.options.shaded.enabled) {
							...
							if (d.hasOwnProperty(s[e]) || (d[s[e]] = f.calcPath(l, t)), "group" === t.options.shaded.orientation) {
					...
					for (m.draw(s, r, this.framework), e = 0; e < s.length; e++)
						if (t = this.groups[s[e]], r[s[e]].length > 0) switch (t.options.style) {
							case "line":
								d.hasOwnProperty(s[e]) || (d[s[e]] = f.calcPath(r[s[e]], t)), f.draw(d[s[e]], t, this.framework);
							case "point":
							case "points":
				...
				for (s = 0; s < t.length; s++) {
					...
					if (1 == n.options.sort) {
						var l = function (t, e) {
							...
							p = Math.min(d.length, r.binarySearchValue(d, o, "x", "after", l) + 1);
						p <= 0 && (p = d.length);
						var c = new Array(p - u);
			...
			if (t.length > 0) {
				for (var u = 0; u < t.length; u++) {
					...
					p && "right" != p.options.yAxisOrientation ? (s = !0, a = 1e9, d = -1e9) : p && p.options.yAxisOrientation && (r = !0, h = 1e9, l = -1e9)
				}
			...
			var c = ["__barStackLeft", "__barStackRight", "__lineStackLeft", "__lineStackRight"];
			for (u = 0; u < c.length; u++) - 1 != t.indexOf(c[u]) && t.splice(t.indexOf(c[u]), 1);
			return n
		...
		o.prototype.setCharHeight = function (t) {
			...
			for (var a = t.convertValue(0), h = t.getStep() * t.scale, d = !1, l = 0; !d && l++ < 5;) {
				...
				} else this.autoScaleStart ? (this._start -= m / this.scale, this._end = this._start + u) : (this._start += c - m / this.scale, this._end = this._start + u);
		...
		o.drawIcon = function (t, e, i, o, s, r) {
			...
			if (n.drawBar(e + .5 * d + m, i + a - p - 1, d, p, t.className + " vis-bar", r.svgElements, r.svg, t.style), n.drawBar(e + 1.5 * d + m + 2, i + a - c - 1, d, c, t.className + " vis-bar", r.svgElements, r.svg, t.style), 1 == t.options.drawPoints.enabled) {
				var f = {
				...
				n.drawPoint(e + .5 * d + m, i + a - p - 1, f, r.svgElements, r.svg), n.drawPoint(e + 1.5 * d + m + 2, i + a - c - 1, f, r.svgElements, r.svg)
			}
			...
			for (l = 0; l < t.length; l++)
				if (d = i.groups[t[l]], "bar" === d.options.style && !0 === d.visible && (void 0 === i.options.groups.visibility[t[l]] || !0 === i.options.groups.visibility[t[l]]))
					for (u = 0; u < e[t[l]].length; u++) p.push({
			...
			if (0 !== m)
				for (p.sort(function (t, e) {
					...
					var f = void 0 != d.options.barChart.minWidth ? d.options.barChart.minWidth : .1 * d.options.barChart.width;
					a = p[l].screen_x;
					var g = 0;
					if (void 0 === c[a]) l + 1 < p.length && (r = Math.abs(p[l + 1].screen_x - a)), h = o._getSafeDrawData(r, d, f);
					else {
						var v = l + (c[a].amount - c[a].resolved);
						v < p.length && (r = Math.abs(p[v].screen_x - a)), h = o._getSafeDrawData(r, d, f), c[a].resolved += 1, !0 === d.options.stack && !0 !== d.options.excludeFromStacking ? p[l].screen_y < d.zeroPosition ? (g = c[a].accumulatedNegative, c[a].accumulatedNegative += d.zeroPosition - p[l].screen_y) : (g = c[a].accumulatedPositive, c[a].accumulatedPositive += d.zeroPosition - p[l].screen_y) : !0 === d.options.barChart.sideBySide && (h.width = h.width / c[a].amount, h.offset += c[a].resolved * h.width - .5 * h.width * (c[a].amount + 1))
					}
					var y = h.width,
						b = p[l].screen_x;
					if (void 0 != p[l].screen_end ? (y = p[l].screen_end - p[l].screen_x, b += .5 * y) : b += h.offset, n.drawBar(b, p[l].screen_y - g, y, d.zeroPosition - p[l].screen_y, d.className + " vis-bar", i.svgElements, i.svg, d.style), !0 === d.options.drawPoints.enabled) {
						var _ = {
		...
		o.calcPath = function (t, e) {
			...
			var o, n, s, r, a, h, d, l, u, p, c, m, f, g, v, y, b, _, w, x = [];
			x.push([Math.round(t[0].screen_x), Math.round(t[0].screen_y)]);
			for (var D = t.length, S = 0; S < D - 1; S++) o = 0 == S ? t[0] : t[S - 1], n = t[S], s = t[S + 1], r = S + 2 < D ? t[S + 2] : s, d = Math.sqrt(Math.pow(o.screen_x - n.screen_x, 2) + Math.pow(o.screen_y - n.screen_y, 2)), l = Math.sqrt(Math.pow(n.screen_x - s.screen_x, 2) + Math.pow(n.screen_y - s.screen_y, 2)), u = Math.sqrt(Math.pow(s.screen_x - r.screen_x, 2) + Math.pow(s.screen_y - r.screen_y, 2)), g = Math.pow(u, i), y = Math.pow(u, 2 * i), v = Math.pow(l, i), b = Math.pow(l, 2 * i), w = Math.pow(d, i), _ = Math.pow(d, 2 * i), p = 2 * _ + 3 * w * v + b, c = 2 * y + 3 * g * v + b, m = 3 * w * (w + v), m > 0 && (m = 1 / m), f = 3 * g * (g + v), f > 0 && (f = 1 / f), a = {
				screen_x: (-b * o.screen_x + p * n.screen_x + _ * s.screen_x) * m,
				screen_y: (-b * o.screen_y + p * n.screen_y + _ * s.screen_y) * m
			}, h = {
				screen_x: (y * n.screen_x + c * s.screen_x - b * r.screen_x) * f,
				screen_y: (y * n.screen_y + c * s.screen_y - b * r.screen_y) * f
		...
		e.util = i(0), e.DOMutil = i(11), e.DataSet = i(15), e.DataView = i(20), e.Queue = i(65), e.Timeline = i(129), e.Graph2d = i(138), e.timeline = {
			Core: i(48),
			DateUtil: i(21),
			Range: i(47),
			stack: i(71),
		...
		}, e.moment = i(3), e.Hammer = i(12), e.keycharm = i(68)
	}, function (t, e, i) {
		t.exports = {
			default: i(87),
			__esModule: !0
		...
		var o = i(6),
			...
			B = Y && "symbol" == typeof E.iterator ? function (t) {
				return "symbol" == typeof t
			} : function (t) {
				return t instanceof E
			},
			U = function (t, e, i) {
				return t === j && U(H, e, i), y(t), e = _(e, !0), y(i), n(F, e) ? (i.enumerable ? (n(t, N) && t[N][e] && (t[N][e] = !1), i = x(i, {
					enumerable: w(0, !1)
				})) : (n(t, N) || M(t, N, w(1, {})), t[N][e] = !0), W(t, e, i)) : M(t, e, i)
			},
			q = function (t, e) {
				y(t);
				for (var i, o = g(e = b(e)), n = 0, s = o.length; s > n;) U(t, i = o[n++], e[i]);
				return t
			},
			X = function (t, e) {
			...
			Z = function (t) {
				...
				return !(this === j && n(F, t) && !n(H, t)) && (!(e || !n(this, t) || !n(F, t) || n(this, N) && this[N][t]) || e)
			},
			K = function (t, e) {
				if (t = b(t), e = _(e, !0), t !== j || !n(F, e) || n(H, e)) {
					var i = T(t, e);
					return !i || !n(F, e) || n(t, N) && t[N][e] || (i.enumerable = !0), i
				}
			},
			J = function (t) {
				for (var e, i = O(b(t)), o = [], s = 0; i.length > s;) n(F, e = i[s++]) || e == N || e == h || o.push(e);
				return o
			},
			$ = function (t) {
				for (var e, i = t === j, o = O(i ? H : b(t)), s = [], r = 0; o.length > r;) !n(F, e = o[r++]) || i && !n(j, e) || s.push(F[e]);
				return s
			};
		Y || (E = function () {
		...
		for (var Q = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), tt = 0; Q.length > tt;) c(Q[tt++]);
		...
		r(r.S + r.F * !Y, "Symbol", {
			...
			stringify: function (t) {
				if (void 0 !== t && !B(t)) {
					...
					return e = o[1], "function" == typeof e && (i = e), !i && v(e) || (e = function (t, e) {
						if (i && (e = i.call(this, t, e)), !B(e)) return e
					}), o[1] = e, I.apply(P, o)
				}
			}
		}), E.prototype[A] || i(14)(E.prototype, A, E.prototype.valueOf), u(E, "Symbol"), u(Math, "Math", !0), u(o.JSON, "JSON", !0)
	}, function (t, e, i) {
		var o = i(27)("meta"),
			n = i(24),
			s = i(10),
		...
		(function (t) {
			! function (e, i) {
				...
				function g(t, e) {
					var i, o, n;
					if (s(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), s(e._i) || (t._i = e._i), s(e._f) || (t._f = e._f), s(e._l) || (t._l = e._l), s(e._strict) || (t._strict = e._strict), s(e._tzm) || (t._tzm = e._tzm), s(e._isUTC) || (t._isUTC = e._isUTC), s(e._offset) || (t._offset = e._offset), s(e._pf) || (t._pf = c(e)), s(e._locale) || (t._locale = e._locale), Oo.length > 0)
						for (i = 0; i < Oo.length; i++) o = Oo[i], n = e[o], s(n) || (t[o] = n);
					return t
				}
				...
				function W(t) {
					var e, i, o = t.match(jo);
					for (e = 0, i = o.length; e < i; e++) zo[o[e]] ? o[e] = zo[o[e]] : o[e] = z(o[e]);
					return function (e) {
						var n, s = "";
				...
				function $t(e) {
					var i = null;
					if (!Ln[e] && void 0 !== t && t && t.exports) try {
						i = In._abbr;
						! function () {
				...
				function te(t, e) {
					if (null !== e) {
						var i = Rn;
						if (e.abbr = t, null != Ln[t]) S("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), i = Ln[t]._config;
						else if (null != e.parentLocale) {
							if (null == Ln[e.parentLocale]) return Fn[e.parentLocale] || (Fn[e.parentLocale] = []), Fn[e.parentLocale].push({
								name: t,
								config: e
							}), null;
				...
				function ee(t, e) {
					if (null != e) {
						var i, o = Rn;
						null != Ln[t] && (o = Ln[t]._config), e = T(o, e), i = new M(e), i.parentLocale = Ln[t], Ln[t] = i, Qt(t)
				...
				function ne(t) {
					var e, i = t._a;
					return i && -2 === c(t).overflow && (e = i[ln] < 0 || i[ln] > 11 ? ln : i[un] < 1 || i[un] > ht(i[dn], i[ln]) ? un : i[pn] < 0 || i[pn] > 24 || 24 === i[pn] && (0 !== i[cn] || 0 !== i[mn] || 0 !== i[fn]) ? pn : i[cn] < 0 || i[cn] > 59 ? cn : i[mn] < 0 || i[mn] > 59 ? mn : i[fn] < 0 || i[fn] > 999 ? fn : -1, c(t)._overflowDayOfYear && (e < dn || e > un) && (e = un), c(t)._overflowWeeks && -1 === e && (e = gn), c(t)._overflowWeekday && -1 === e && (e = vn), c(t).overflow = e), t
				}
				...
				function ae(t) {
					var e, i, o, n, s = [];
					if (!t._d) {
						for (o = re(t), t._w && null == t._a[un] && null == t._a[ln] && he(t), null != t._dayOfYear && (n = se(t._a[dn], o[dn]), (t._dayOfYear > Q(n) || 0 === t._dayOfYear) && (c(t)._overflowDayOfYear = !0), i = _t(n, 0, t._dayOfYear), t._a[ln] = i.getUTCMonth(), t._a[un] = i.getUTCDate()), e = 0; e < 3 && null == t._a[e]; ++e) t._a[e] = s[e] = o[e];
				...
				function he(t) {
					var e, i, o, n, s, r, a, h;
					if (e = t._w, null != e.GG || null != e.W || null != e.E) s = 1, r = 4, i = se(e.GG, t._a[dn], Dt(ke(), 1, 4).year), o = se(e.W, 1), ((n = se(e.E, 1)) < 1 || n > 7) && (h = !0);
					else {
				...
				function fe(t) {
					...
					if (e) {
						...
						t._a = i, t._tzm = me(e[8], e[9], e[10]), t._d = _t.apply(null, t._a), t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), c(t).rfc2822 = !0
					} else t._isValid = !1
				}
				...
				function ge(t) {
					...
					de(t), !1 === t._isValid && (delete t._isValid, fe(t), !1 === t._isValid && (delete t._isValid, e.createFromInputFallback(t)))
				}
				...
				function ve(t) {
					...
					var i, o, n, s, r, a = "" + t._i,
						h = a.length,
						d = 0;
					for (n = B(t._f, t._locale).match(jo) || [], i = 0; i < n.length; i++) s = n[i], o = (a.match(q(s, t)) || [])[0], o && (r = a.substr(0, a.indexOf(o)), r.length > 0 && c(t).unusedInput.push(r), a = a.slice(a.indexOf(o) + o.length), d += o.length), zo[s] ? (o ? c(t).empty = !1 : c(t).unusedTokens.push(s), $(s, o, t)) : t._strict && !o && c(t).unusedTokens.push(s);
				...
				function be(t) {
					...
					for (n = 0; n < t._f.length; n++) s = 0, e = g({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[n], ve(e), m(e) && (s += c(e).charsLeftOver, s += 10 * c(e).unusedTokens.length, c(e).score = s, (null == o || s < o) && (o = s, i = e));
					l(t, i || e)
				}
				...
				function xe(t) {
					var e = t._i,
						o = t._f;
					return t._locale = t._locale || ie(t._l), null === e || void 0 === o && "" === e ? f({
						nullInput: !0
					}) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), y(e) ? new v(ne(e)) : (a(e) ? t._d = e : i(o) ? be(t) : o ? ve(t) : De(t), m(t) || (t._d = null), t))
				}

				function De(t) {
					var n = t._i;
					s(n) ? t._d = new Date(e.now()) : a(n) ? t._d = new Date(n.valueOf()) : "string" == typeof n ? ge(t) : i(n) ? (t._a = h(n.slice(0), function (t) {
				...
				function Ie(t) {
					var e = F(t),
						...
						d = e.second || 0,
						l = e.millisecond || 0;
					this._isValid = Oe(e), this._milliseconds = +l + 1e3 * d + 6e4 * h + 1e3 * a * 60 * 60, this._days = +r + 7 * s, this._months = +n + 3 * o + 12 * i, this._data = {}, this._locale = ie(), this._bubble()
				}
				...
				function Fe(t, i) {
					var o, n;
					return i._isUTC ? (o = i.clone(), n = (y(t) || a(t) ? t.valueOf() : ke(t).valueOf()) - o.valueOf(), o._d.setTime(o._d.valueOf() + n), e.updateOffset(o, !1), o) : ke(t).local()
				}
				...
				function je(t, i, o) {
					...
					if (null != t) {
						...
						return !this._isUTC && i && (n = He(this)), this._offset = t, this._isUTC = !0, null != n && this.add(n, "m"), s !== t && (!i || this._changeInProgress ? ei(this, Ke(t - s, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, e.updateOffset(this, !0), this._changeInProgress = null)), this
					}
				...
				function Ke(t, e) {
					...
					return Ne(t) ? s = {
						...
						m: Je(a[7], i),
						s: Je(a[8], i)
					}) : null == s ? s = {} : "object" == typeof s && ("from" in s || "to" in s) && (n = Qe(ke(s.from), ke(s.to)), s = {}, s.ms = n.milliseconds, s.M = n.months), o = new Ie(s), Ne(t) && d(t, "_locale") && (o._locale = t._locale), o
				}
				...
				function Qe(t, e) {
					var i;
					return t.isValid() && e.isValid() ? (e = Fe(e, t), t.isBefore(e) ? i = $e(t, e) : (i = $e(e, t), i.milliseconds = -i.milliseconds, i.months = -i.months), i) : {
						milliseconds: 0,
						months: 0
					}
				}
				...
				function ei(t, i, o, n) {
					var s = i._milliseconds,
						r = Ae(i._days),
						a = Ae(i._months);
					t.isValid() && (n = null == n || n, a && ct(t, ot(t, "Month") + a * o), r && nt(t, "Date", ot(t, "Date") + r * o), s && t._d.setTime(t._d.valueOf() + s * o), n && e.updateOffset(t, r || a))
				}
				...
				function si(t, e) {
					var i = y(t) ? t : ke(t);
					return !(!this.isValid() || !i.isValid()) && (e = L(s(e) ? "millisecond" : e), "millisecond" === e ? this.valueOf() > i.valueOf() : i.valueOf() < this.clone().startOf(e).valueOf())
				}

				function ri(t, e) {
					var i = y(t) ? t : ke(t);
					return !(!this.isValid() || !i.isValid()) && (e = L(s(e) ? "millisecond" : e), "millisecond" === e ? this.valueOf() < i.valueOf() : this.clone().endOf(e).valueOf() < i.valueOf())
				}
				...
				function hi(t, e) {
					var i, o = y(t) ? t : ke(t);
					return !(!this.isValid() || !o.isValid()) && (e = L(e || "millisecond"), "millisecond" === e ? this.valueOf() === o.valueOf() : (i = o.valueOf(), this.clone().startOf(e).valueOf() <= i && i <= this.clone().endOf(e).valueOf()))
				}
				...
				function mi() {
					...
					return t.year() < 0 || t.year() > 9999 ? V(t, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]") : k(Date.prototype.toISOString) ? this.toDate().toISOString() : V(t, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]")
				}
				...
				function vi(t, e) {
					return this.isValid() && (y(t) && t.isValid() || ke(t).isValid()) ? Ke({
						to: this,
						from: t
				...
				function Yi(t, e, i, o, n) {
					var s;
					return null == t ? Dt(this, o, n).year : (s = St(t, o, n), e > s && (e = s), Gi.call(this, t, e, i, o, n))
				}
				...
				function lo() {
					var t, e, i, o, n, s = this._milliseconds,
						...
						a = this._months,
						h = this._data;
					return s >= 0 && r >= 0 && a >= 0 || s <= 0 && r <= 0 && a <= 0 || (s += 864e5 * ho(po(a) + r), r = 0, a = 0), h.milliseconds = s % 1e3, t = b(s / 1e3), h.seconds = t % 60, e = b(t / 60), h.minutes = e % 60, i = b(e / 60), h.hours = i % 24, r += b(i / 24), n = b(uo(r)), a += n, r -= ho(po(n)), o = b(a / 12), a %= 12, h.days = r, h.months = a, h.years = o, this
				}
				...
				function co(t) {
					...
					if ("month" === (t = L(t)) || "year" === t) return e = this._days + o / 864e5, i = this._months + uo(e), "month" === t ? i : i / 12;
				...
				function wo(t, e, i) {
					var o = Ke(t).abs(),
						...
						h = ks(o.as("M")),
						d = ks(o.as("y")),
						l = n <= Cs.ss && ["s", n] || n < Cs.s && ["ss", n] || s <= 1 && ["m"] || s < Cs.m && ["mm", s] || r <= 1 && ["h"] || r < Cs.h && ["hh", r] || a <= 1 && ["d"] || a < Cs.d && ["dd", a] || h <= 1 && ["M"] || h < Cs.M && ["MM", h] || d <= 1 && ["y"] || ["yy", d];
				...
				function Co() {
					if (!this.isValid()) return this.localeData().invalidDate();
					var t, e, i, o = Ts(this._milliseconds) / 1e3,
						n = Ts(this._days),
						s = Ts(this._months);
					...
					return c + "P" + (r ? m + r + "Y" : "") + (a ? m + a + "M" : "") + (h ? f + h + "D" : "") + (d || l || u ? "T" : "") + (d ? g + d + "H" : "") + (l ? g + l + "M" : "") + (u ? g + u + "S" : "")
				}
				var To, Mo;
				...
				var _n = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
					...
					Dn = rn,
					Sn = rn;
				G("w", ["ww", 2], "wo", "week"), G("W", ["WW", 2], "Wo", "isoWeek"), R("week", "w"), R("isoWeek", "W"), H("week", 5), H("isoWeek", 5), U("w", Xo), U("ww", Xo, Vo), U("W", Xo), U("WW", Xo, Vo), J(["w", "ww", "W", "WW"], function (t, e, i, o) {
					e[o.substr(0, 1)] = _(t)
				});
				var kn = {
					dow: 0,
				...
				var Cn = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
					...
					En = rn,
					Pn = rn;
				G("H", ["HH", 2], 0, "hour"), G("h", ["hh", 2], 0, Vt), G("k", ["kk", 2], 0, Bt), G("hmm", 0, 0, function () {
					...
					var o = t.length - 2;
					e[pn] = _(t.substr(0, o)), e[cn] = _(t.substr(o)), c(i).bigHour = !0
				}), K("hmmss", function (t, e, i) {
					var o = t.length - 4,
						n = t.length - 2;
					e[pn] = _(t.substr(0, o)), e[cn] = _(t.substr(o, 2)), e[mn] = _(t.substr(n)), c(i).bigHour = !0
				}), K("Hmm", function (t, e, i) {
					var o = t.length - 2;
					...
					var o = t.length - 4,
						n = t.length - 2;
					e[pn] = _(t.substr(0, o)), e[cn] = _(t.substr(o, 2)), e[mn] = _(t.substr(n))
				});
				var In, Nn = /[ap]\.?m?\.?/i,
					An = it("Hours", !0),
					Rn = {
				...
				var Un = D("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function () {
				...
				Re("Z", ":"), Re("ZZ", ""), U("Z", nn), U("ZZ", nn), K(["Z", "ZZ"], function (t, e, i) {
				...
				var es = D("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function (t) {
				...
				var is = it("Date", !0);
				G("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), R("dayOfYear", "DDD"), H("dayOfYear", 4), U("DDD", Jo), U("DDDD", Bo), K(["DDD", "DDDD"], function (t, e, i) {
					i._dayOfYear = _(t)
				}), G("m", ["mm", 2], 0, "minute"), R("minute", "m"), H("minute", 14), U("m", Xo), U("mm", Xo, Vo), K(["m", "mm"], cn);
				var os = it("Minutes", !1);
				G("s", ["ss", 2], 0, "second"), R("second", "s"), H("second", 15), U("s", Xo), U("ss", Xo, Vo), K(["s", "ss"], mn);
				var ns = it("Seconds", !1);
				G("S", 0, 0, function () {
				...
				}), R("millisecond", "ms"), H("millisecond", 16), U("S", Jo, Wo), U("SS", Jo, Vo), U("SSS", Jo, Bo);
				var ss;
				...
				}), e.lang = D("moment.lang is deprecated. Use moment.locale instead.", Qt), e.langData = D("moment.langData is deprecated. Use moment.localeData instead.", ie);
				var ds = Math.abs,
					ls = fo("ms"),
					us = fo("s"),
					ps = fo("m"),
		...
		(function (e) {
			...
			function n(t, e, i) {
				...
				var r = void 0 !== t.clockseq ? t.clockseq : f,
					...
					d = a - g + (h - v) / 1e4;
				if (d < 0 && void 0 === t.clockseq && (r = r + 1 & 16383), (d < 0 || a > g) && void 0 === t.nsecs && (h = 0), h >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
			...
			for (var l = [], u = {}, p = 0; p < 256; p++) l[p] = (p + 256).toString(16).substr(1), u[l[p]] = p;
			var c = r(),
		...
		function o(t, e, i, n) {
			...
			if (this.defaultOptions = {
				...
				for (var p, f = this.dom.root; !p && f;) p = window.getComputedStyle(f, null).direction, f = f.parentElement;
			...
			this.options.rollingMode = n && n.rollingMode, this.options.onInitialDrawComplete = n && n.onInitialDrawComplete, this.components = [], this.body = {
				...
				if (null != this.itemsData && !this.options.rollingMode) {
					if (!r.initialFitDone)
						if (r.initialFitDone = !0, void 0 != r.options.start || void 0 != r.options.end) {
		...
		var a = i(3),
			...
			_ = i(76).default,
			w = i(32).default;
		o.prototype = new p, o.prototype._createConfigurator = function () {
			...
			if (t) {
				...
				e = t instanceof d || t instanceof l ? new l(t, {
					filter: i
				}) : new d(t.filter(i))
			} else e = null;
			...
			if (this.itemsData && void 0 != t) {
				...
				if (o.forEach(function (t) {
					...
					g || (l = {
						...
						scrollOffset: -1,
						itemTop: -1
					}), this.range.setRange(m - f / 2, m + f / 2, {
						animation: g
					}, c, u)
				}
			}
		}, o.prototype.fit = function (t, e) {
			var i, o = !t || void 0 === t.animation || t.animation,
				n = this.itemsData && this.itemsData.getDataSet();
			1 === n.length && void 0 === n.get()[0].end ? (i = this.getDataRange(), this.moveTo(i.min.valueOf(), {
				animation: o
			...
			if (null != e && null != i) {
				...
				if (u > 0)
					for (var p = 0; p < u; p++) h.forEach(l, function (t) {
						t[p]()
					});
				if (h.forEach(this.itemSet.items, function (t) {
					...
					f > 0 && (this.options.rtl ? (e = n(o) - m * a / f, i = s(r) + c * a / f) : (e = n(o) - c * a / f, i = s(r) + m * a / f))
				}
			}
			return {
			...
			var n = o - h.getAbsoluteTop(this.dom.centerContainer),
				...
				m = h.getTarget(t),
				g = null;
			return null != s ? g = "item" : null != a ? g = "custom-time" : h.hasParent(m, this.timeAxis.dom.foreground) ? g = "axis" : this.timeAxis2 && h.hasParent(m, this.timeAxis2.dom.foreground) ? g = "axis" : h.hasParent(m, this.itemSet.dom.labelSet) ? g = "group-label" : h.hasParent(m, this.currentTime.bar) ? g = "current-time" : h.hasParent(m, this.dom.center) && (g = "background"), {
				event: t,
				item: s ? s.id : null,
		...
		! function (n, s, r, a) {
			...
			function E(t, e) {
				...
				var s = i.firstInput,
					...
					h = e.center = A(o);
				e.timeStamp = _t(), e.deltaTime = e.timeStamp - s.timeStamp, e.angle = H(a, h), e.distance = F(a, h), P(i, e), e.offsetDirection = L(e.deltaX, e.deltaY);
				var d = R(e.deltaTime, e.deltaX, e.deltaY);
				e.overallVelocityX = d.x, e.overallVelocityY = d.y, e.overallVelocity = bt(d.x) > bt(d.y) ? d.x : d.y, e.scale = r ? Y(r.pointers, o) : 1, e.rotation = r ? j(r.pointers, o) : 0, e.maxPointers = i.prevInput ? e.pointers.length > i.prevInput.maxPointers ? e.pointers.length : i.prevInput.maxPointers : e.pointers.length, I(i, e);
				var l = t.element;
			...
			function P(t, e) {
				var i = e.center,
					...
					n = t.prevDelta || {},
					s = t.prevInput || {};
				e.eventType !== Ot && s.eventType !== Pt || (n = t.prevDelta = {
					x: s.deltaX || 0,
					y: s.deltaY || 0
				}, o = t.offsetDelta = {
					x: i.x,
			...
			function I(t, e) {
				...
				if (e.eventType != It && (h > Mt || r.velocity === a)) {
					var d = e.deltaX - r.deltaX,
						l = e.deltaY - r.deltaY,
						u = R(h, d, l);
					o = u.x, n = u.y, i = bt(u.x) > bt(u.y) ? u.x : u.y, s = L(d, l), t.lastInterval = e
			...
			function V(t, e) {
				...
				return e & (Pt | It) && (i = D(i.concat(o), "identifier", !0)), [i, o]
			}
			...
			function U(t, e) {
				var i = x(t.touches),
					o = this.targetIds;
				if (e & (Ot | Et) && 1 === i.length) return o[i[0].identifier] = !0, [i, i];
			...
			function q() {
				...
				this.touch = new B(this.manager, t), this.mouse = new G(this.manager, t), this.primaryTouch = null, this.lastTouches = []
			}
			...
			p(G, T, {
				handler: function (t) {
					var e = Wt[t.type];
					e & Ot && 0 === t.button && (this.pressed = !0), e & Et && 1 !== t.which && (e = Pt), this.pressed && (e & Pt && (this.pressed = !1), this.callback(this.manager, e, {
						pointers: [t],
						changedPointers: [t],
						pointerType: "mouse",
						srcEvent: t
			...
			n.MSPointerEvent && !n.PointerEvent && (Xt = "MSPointerDown", Zt = "MSPointerMove MSPointerUp MSPointerCancel"), p(z, T, {
				handler: function (t) {
					var e = this.store,
						i = !1,
					...
					n & Ot && (0 === t.button || r) ? a < 0 && (e.push(t), a = e.length - 1) : n & (Pt | It) && (i = !0), a < 0 || (e[a] = t, this.callback(this.manager, n, {
						pointers: e,
						changedPointers: [t],
						pointerType: s,
						srcEvent: t
			...
			Q.prototype = {
				...
				emit: function (t) {
					...
					var i = this,
						o = this.state;
					o < me && e(i.options.event + tt(o)), e(i.options.event), t.additionalEvent && e(t.additionalEvent), o >= me && e(i.options.event + tt(o))
				},
				tryEmit: function (t) {
				...
				recognize: function (t) {
					var e = mt({}, t);
					if (!m(this.options.enable, [this, e])) return this.reset(), void(this.state = 32);
					this.state & (fe | ge | 32) && (this.state = ue), this.state = this.process(e), this.state & (pe | ce | me | ge) && this.tryEmit(e)
				},
				process: function (t) {},
				...
				process: function (t) {
					var e = this.state,
						...
						o = e & (pe | ce),
						n = this.attrTest(t);
					return o && (i & It || !n) ? e | ge : o || n ? i & Pt ? e | me : e & pe ? e | ce : pe : 32
				}
			}), p(nt, ot, {
				defaults: {
					event: "pan",
				...
				directionTest: function (t) {
					var e = this.options,
						...
						s = t.deltaX,
						r = t.deltaY;
					return n & e.direction || (e.direction & Ht ? (n = 0 === s ? Nt : s < 0 ? At : Rt, i = s != this.pX, o = Math.abs(t.deltaX)) : (n = 0 === r ? Nt : r < 0 ? Lt : Ft, i = r != this.pY, o = Math.abs(t.deltaY))), t.direction = n, i && o > e.threshold && n & e.direction
				},
				attrTest: function (t) {
				...
				process: function (t) {
					...
					else if (t.eventType & Ot) this.reset(), this._timer = h(function () {
				...
				attrTest: function (t) {
					var e, i = this.options.direction;
					return i & (Ht | jt) ? e = t.overallVelocity : i & Ht ? e = t.overallVelocityX : i & jt && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && bt(e) > this.options.velocity && t.eventType & Pt
				},
				emit: function (t) {
			...
			ut.prototype = {
				...
				recognize: function (t) {
					...
					if (!e.stopped) {
						...
						for (var s = 0; s < o.length;) i = o[s], 2 === e.stopped || n && i != n && !i.canRecognizeWith(n) ? i.reset() : i.recognize(t), !n && i.state & (pe | ce | me) && (n = e.curRecognizer = i), s++
					}
				},
				get: function (t) {
		...
		var n = i(16),
			...
			c = function () {
				...
				return (0, d.default)(t, [{
					...
					value: function () {
						var t = this;
						!0 === (!(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0]) && (this.previousColor = p.extend({}, this.color)), !0 === this.applied && this.updateCallback(this.initialColor), this.frame.style.display = "none", setTimeout(function () {
					...
					key: "_setColor",
					value: function (t) {
						!0 === (!(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1]) && (this.initialColor = p.extend({}, t)), this.color = t;
					...
					value: function () {
						if (!1 === this.generated) {
							...
							var a = 2 * Math.PI / 360,
								...
								d = void 0;
							for (s = 0; s < 360; s++)
								for (r = 0; r < this.r; r++) o = this.centerCoordinates.x + r * Math.sin(a * s), n = this.centerCoordinates.y + r * Math.cos(a * s), d = p.HSVToRGB(s * (1 / 360), r * h, 1), t.fillStyle = "rgb(" + d.r + "," + d.g + "," + d.b + ")", t.fillRect(o - .5, n - .5, 2, 2);
		...
		o.prototype = new d, o.prototype.setOptions = function (t) {
			...
			return !u.hidden && this.itemsData.length > 0 && l.push(u.screenToValue(n)), !c.hidden && this.itemsData.length > 0 && l.push(c.screenToValue(n)), {
				event: t,
				what: d,
				pageX: t.srcEvent ? t.srcEvent.pageX : t.pageX,
				pageY: t.srcEvent ? t.srcEvent.pageY : t.pageY,
